...
function isPatternNext(pattern, pos, flags, needlePattern) {
    ...
    var patternsToIgnore = flags.indexOf('x') > -1 ?
        // Ignore any leading whitespace, line comment, and inline comment
        ['\\s', lineCommentPattern, inlineCommentPattern] :
        // Ignore any leading inline comment
 ...
 *     - `x` - free-spacing and line comment (aka extended)
...
/*
 * Comment pattern: `(?# )`. Inline comment are an alternative to the line comment allowed in
...
/*
 * Whitespace and line comment, in free-spacing mode (aka extended mode, flag x) only.
 */
XRegExp.addToken(
    /\s+|#[^\n]*\n?/,
    getContextualTokenSeparator,
